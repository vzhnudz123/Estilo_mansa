...
export const IMMERSIVE_IMAGES = [img8817, img8818, img8819, img8820];

/** Story section background */
export const STORY_BG = img8823;
...
const curatedGalleryImages = [
  ...
  { src: img8816, label: 'Terrace' },
  { src: img8817, label: 'Mist Morning' },
  { src: img8818, label: 'Living Suite' },
  { src: img8819, label: 'Master Bedroom' },
  { src: img8820, label: 'Dining Area' },
  { src: img8821, label: 'Cozy Corner' },
  { src: img8822, label: 'Detail Arch' },
